...
@import url(app.css.php);
@import url(shop.plugins.css.php);
@import url(shop.blocks.css.php);

@import url(plugins/style-switcher.css.php);
...
@media (max-width:991px){.heading h2:before,.heading h2:after{ width:65%}
}

@media (max-width:768px){.heading h2:before,.heading h2:after{ width:35%}
}
...
.product-description .title-price{color:#687074; font-size:16px}
...
.illustration-v3.illustration-img1{background-image:url(../img/home_page/vida_nam.jpg)}

.illustration-v3.illustration-img2{background-image:url(../img/home_page/dl.jpg)}

.illustration-v3.illustration-img3{background-image:url(../img/home_page/tui_ipad.jpg)}
...
.collection-banner{padding:50px 0; position:relative; background-size:cover; background-repeat:no-repeat;     background-position:center center; background-image:url(../img/banner-2.jpg)}
